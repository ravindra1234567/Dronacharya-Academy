...
--
-- Host: localhost
-- Generation Time: Jul 05, 2020 at 08:27 PM
...
CREATE TABLE `batch` (
  ...
  `language` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'english=1,hindi=0',
  `stream` tinyint(1) NOT NULL DEFAULT 6 COMMENT 'bio=0,math=1,art=2,commerce=3,agriculture=4',
  `show_subjects` varchar(255) DEFAULT NULL,
...
CREATE TABLE `state` (
  `id` int(11) NOT NULL,
  `state_name` varchar(30) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
