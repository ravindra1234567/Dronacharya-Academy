...
<div class="container">
	...
	<button type="button" class="btn btn-primary ml-4 shadow-xlg p-1 mb-4 mt-2 show1" data-toggle="collapse" data-target="#english">Read more</button>
	<div>
	...
	</div><button type="button" class="btn btn-primary ml-4 shadow-xlg p-1 mb-4 mt-2 show1" data-toggle="collapse" data-target="#hindi">Read more</button>
</div>
